...
项目目前处于可验证的垂直切片阶段。正式酒吧环境、双世界表现、柜体与工具交互、参数化液体、数据驱动工序、每日循环和测试管线已经接入；第一阶段 9 杯正式配方与量酒器容量已经登记。冰美式仍是部分实现，其余 8 杯仅进入正式目录；平衡、顾客内容及多数配方物品美术仍未完成。
...
- 正式内容目录包含 9 杯配方和 26 个成分形态；量酒器容量为 `10/20`、`15/30`、`25/50 ml`。
...
- 已批准的配方正文与量酒器容量可标记为正式；容差、概率、恢复曲线、奖励、顾客故事和最终美术在明确批准前仍须标记为原型或占位。
