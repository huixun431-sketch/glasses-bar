...
- 已用实际 Forward+ Movie Maker 生成 11 张 1280×720 审批图，并逐张检查方位、玩家视角、U 内部、湿区/员工门、手册、开上柜门、开冰桶抽屉、拉出客椅、南门窗、现实/眼镜灯光。路径与 SHA-256 见 `docs/CONTEXT_HANDOFF.md`。
