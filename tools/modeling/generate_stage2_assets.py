...
def build_traditional_filter(materials: dict[str, bpy.types.Material]) -> bpy.types.Object:
    ...
    add_frustum_shell(root, "FilterCup", 0.036, 0.142, 0.096, 0.122, 0.086, 0.110, metal,
                      close_bottom=True, close_top=False)
    add_frustum_shell(root, "FunnelBasket", 0.030, 0.130, 0.030, 0.104, 0.021, 0.092, metal,
    ...
    add_torus(root, "StabilityFoot", 0.080, 0.008, 0.031, metal)
